...
#SBATCH --array=301-312,501-512,701-712
#-312,501-512,701-712
...
srun python3 ./../../hmsc-hpc/hmsc/examples/run_gibbs_sampler.py --input $input_path --output $output_path --samples $SAM --transient $(($SAM*$THIN)) --thin $THIN --verbose 100 --fse 0  --profile $PROFILE

#pip install --user --upgrade tensorflow-probability==0.20.0 pyreadr
